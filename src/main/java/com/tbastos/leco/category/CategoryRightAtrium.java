 ...
 * @author Tibério
 */
public final class CategoryRightAtrium extends CategoryComponent {
    
    private String vol = "XXX";
    private final JComboBoxSubcategory comboBoxSize;
    private final JEditButton editButtonSize;
    
    public CategoryRightAtrium() {
      
        jLabelCategory = new JLabelCategory("Átrio direito");
    ...
    protected void setHashCategoryReport() {
        ...
        hashCategoryReport.put("<html>Normal - <b>DEFINIR</b></html>", "Com diâmetros normais; volume estimado em " + vol + " mL/m² (VR \u2264 32 ml/m² em homens; \u2264 27 ml/m² em mulheres). ");
        hashCategoryReport.put("<html>Discreto - <b>DEFINIR</b></html>", "Átrio esquerdo com aumento discreto; volume estimado em " + vol + " mL/m² (VR \u2264 32 ml/m² em homens; \u2264 27 ml/m² em mulheres). ");
        hashCategoryReport.put("<html>Moderado - <b>DEFINIR</b></html>", "Átrio esquerdo com aumento moderado; volume estimado em " + vol + " mL/m² (VR \u2264 32 ml/m² em homens; \u2264 27 ml/m² em mulheres). ");
        hashCategoryReport.put("<html>Importante - <b>DEFINIR</b></html>", "Átrio esquerdo com aumento importante; volume estimado em " + vol + " mL/m² (VR \u2264 32 ml/m² em homens; \u2264 27 ml/m² em mulheres). ");
    }        
